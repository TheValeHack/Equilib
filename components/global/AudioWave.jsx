...
const AudioWave = () => {
  ...
  useEffect(() => {
    ...
    animateBar(bar1Height, 25, 500)
    animateBar(bar2Height, 40, 700)
    animateBar(bar3Height, 30, 450)
    animateBar(bar4Height, 15, 600)
  }, [bar1Height, bar2Height, bar3Height, bar4Height]);

  return (
    <View className='flex-row items-center justify-center h-[15px]'>
